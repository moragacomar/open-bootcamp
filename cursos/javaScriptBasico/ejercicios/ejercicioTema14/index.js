 ...
 * - Lanza el servidor de desarrollo a través del script anterior y prueba que el botón funciona
 *   correctamente
 * - Integra jQuery a través del CDN (https://releases.jquery.com/)
 * - En el fichero index.js crea un evento click en el botón a través de jQuery, que muestre por
 *   consola "Hola, estoy utilizando jQuery"
 */
...
el[0].addEventListener('click', alerta, false);
